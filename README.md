...
With the mixed reward pool and training every two levels, shotgun policies for seeds 4, 15, and 42 reached rounds 65/65/66 at the 7200-second limit, all still alive. Normal’s time, kills, level, and remaining HP match the previous version for all three seeds. A controlled combat test also verifies more than twice the old shotgun’s sustained close-range damage and hits beyond its previous range. These are automated balance checks, not guarantees of human survival.
